...
const NadadorLayout = () => {
  ...
  const handleTogglePanel = () => {
    if (panelAbierto) {
      ...
      abrirPanel() // esto marca como leídas y limpia el badge
    }
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={notificationRef}>
              ...
              >
                ...
                {/* BADGE con cantidad — solo visible si hay notificaciones no leídas */}
                {hayNuevas && (
                  ...
                  <div className="z-50 bg-white border border-slate-100 overflow-hidden shadow-2xl shadow-slate-200/50 fixed bottom-0 left-0 right-0 rounded-t-[2rem] lg:absolute lg:bottom-auto lg:left-auto lg:right-0 lg:top-full lg:mt-3 lg:w-96 lg:rounded-3xl">
                    ...
                    <div className="max-h-[400px] overflow-y-auto p-2">
                      {notificaciones.length > 0 ? (
                        // Las notificaciones ya se limpiaron al abrir el panel (abrirPanel()),
                        // pero las mostramos en el momento del render con el estado previo
                        // gracias a que abrirPanel limpia DESPUÉS de renderizar el panel.
                        // Para esto usamos una ref interna en el hook.
